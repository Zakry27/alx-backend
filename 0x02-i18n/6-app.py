#!/usr/bin/env python3
""" The route module for the API - Use user locale"""
...
def index() -> str:
    ...
    Return: 6-index.html
    """
    returns render_template('6-index.html')


@babel.localeselector
def get_locale() -> str:
    """ It determines best match for supported languages """
...
def get_user() -> Union[dict, None]:
    """ It returns user dict if ID can be found """
...
@app.before_request
def before_request():
    """ It finds user and sets as global on flask.g.user """
    g.user = get_user()
