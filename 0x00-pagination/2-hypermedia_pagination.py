#!/usr/bin/env python3
''' Description: It implements get_hyper method that takes same arguments
                 (and defaults) as get_page and returns dictionary containing
